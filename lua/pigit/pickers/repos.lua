		...
		.new(opts, {
			...
			attach_mappings = function(prompt_bufnr, _)
				...
				vim.keymap.set("i", "<C-d>", function()
					...
					if current_picker then
						current_picker.prompt_border.prompt_title = "Managed Repos ["
							.. utils.get_filter_label(new_mode)
							.. "]"
						refresh_picker()
					end
		...
		define_preview = function(self, entry, _)
			...
			if cached and cached.data then
				...
				table.insert(
					...
					"Status:    "
						.. (meta.staged and "+" or "")
						.. (meta.unstaged and "*" or "")
						.. (meta.untracked and "?" or "")
				)
